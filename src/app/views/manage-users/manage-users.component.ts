...
import { ButtonGroupModule, ButtonModule, FormModule, TextColorDirective, CardComponent, CardHeaderComponent, CardBodyComponent, RowComponent, ColComponent, ButtonDirective, CardModule, GridModule } from '@coreui/angular';

@Component({
  templateUrl: 'manage-users.component.html',
    standalone: true,
  imports: [ButtonGroupModule, ButtonModule, FormModule, ButtonDirective, CardModule, GridModule, TextColorDirective, CardComponent, CardHeaderComponent, CardBodyComponent, RowComponent, forwardRef(() => ThemeColorComponent)]
})
